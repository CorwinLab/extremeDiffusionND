...
if __name__ == "__main__":
    ...
    # largeVIndices = (vs > 0.8 )    # statsFileList = [path003, path01, path03, path1, path3, path10, path31,
    #                  pathLogNormal, pathDelta, pathCorner]
    plt.rcParams.update(
    ...
    if plot:
        ...
        savePath = "/home/fransces/Documents/code/extremeDiffusionND/UniversalFluctsPaper/deviationFromGaussian/variance.png"
        ...
        savepath2 = "/home/fransces/Documents/code/extremeDiffusionND/UniversalFluctsPaper/deviationFromGaussian/scaledVarianceTime.png"
        ...
        plt.xlabel(r"$t$")
        plt.ylabel(r"$\mathrm{Var}_\nu \left[\ln{\left(\mathbb{P}^{\bm{\xi}}\left(|\vec{S}(t)|>r(t)\right)\right)}\right]$")
        savepath3 = "/home/fransces/Documents/code/extremeDiffusionND/UniversalFluctsPaper/deviationFromGaussian/unscaledVarianceTime.png"
