#!/bin/bash
c++ -O3 -c -march=broadwell -Wall -std=gnu++11 -fPIC $(python3-config --includes) diffusionND.cpp -I/c/modular-boost -lquadmath -o diffusionND.o -I"/home/jacob/Desktop/Code/pybind11/include/"
